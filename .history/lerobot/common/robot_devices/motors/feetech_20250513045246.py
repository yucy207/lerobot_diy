...
class FeetechMotorsBus:
    ...
    def read(self, data_name, motor_names: str | list[str] | None = None):
        ...
        for idx in motor_ids:
            if self.motor_models[0] == 'scs0009':
                if bytes == 1:
                    comm, error = self.packet_handler.read1ByteTxRx(self.port_handler, idx, addr)
                elif bytes == 2:
                    comm, error = self.packet_handler.read2ByteTxRx(self.port_handler, idx, addr)
                print('value:',value)
                print('comm_result:',comm)
                print('error:',error)
