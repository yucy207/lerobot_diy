...
def run_arm_manual_calibration(arm: MotorsBus, robot_type: str, arm_name: str, arm_type: str):
    ...
    ```
    """
    print("arm:",arm.motors['module1'])
    print("arm:",arm.motor_names)
    print("read:",arm.read("Torque_Enable"))
    print("TorqueMode.DISABLED.value:",TorqueMode.DISABLED.value)
    if (arm.read("Torque_Enable") != TorqueMode.DISABLED.value).any():
        raise ValueError("To run calibration, the torque must be disabled on all motors.")
    ...
    print("See: " + "./position_images/robopanoptes_zero.jpg")
    input("Press Enter to continue...")
    ...
    print("See: " + "./position_images/robopanoptes_rotated.jpg")
    input("Press Enter to continue...")
    ...
    print("See: " + "./position_images/robopanoptes_rest.jpg")
    input("Press Enter to continue...")
    print()
